    ...
    <div
        ...
        @if (Route::has('login'))
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                <a href="{{ url('/crud') }}"
                    class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">CRUD</a>
                @auth
                    ...
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            <div
                                ...
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPyHEaVvUUIKLOixDLMMYzfqbfntBUtPehXzaRlHrZgGPN5uyOIMEzJ102YH9b47Y9Rtg&usqp=CAU"
                                    alt="">
                            </div>
