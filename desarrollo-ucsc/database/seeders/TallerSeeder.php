...
class TallerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $taller = Taller::create([
            ...
            'cupos_taller' => 25,
            'restricciones_taller' => 'Venir con zapatillas de basketbol',
            'id_admin' => 2,
            'id_espacio' => 2,
        ...
        $taller = Taller::create([
            ...
            'cupos_taller' => 30,
            'restricciones_taller' => 'Venir con canilleras propias',
            'id_admin' => 3,
            'id_espacio' => 3,
        ...
        $taller = Taller::create([
            ...
            'cupos_taller' => 20,
            'restricciones_taller' => 'Venir con zapatillas deportivas',
            'id_admin' => 4,
            'id_espacio' => 4,
        ...
        $taller = Taller::create([
            ...
            'cupos_taller' => 12,
            'restricciones_taller' => 'Raqueta propia sugerida',
            'id_admin' => 5,
            'id_espacio' => 6,
        ...
        $taller = Taller::create([
            ...
            'cupos_taller' => 15,
            'restricciones_taller' => 'Traje de baño obligatorio',
            'id_admin' => 6,
            'id_espacio' => 3,
