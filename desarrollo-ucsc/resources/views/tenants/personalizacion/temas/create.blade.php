...
@section('content')
    @include('layouts.tenants.navbars.ttopnav', ['title' => 'Agregar Tema'])
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('personalizacion.temas.store') }}" method="POST">
                            @csrf

                            <div class="mb-3">
                                <label for="nombre_tema" class="form-label">Nombre del tema</label>
                                <input type="text" name="nombre_tema" id="nombre_tema" class="form-control" required>
                            </div>
                                    ...
                                    <div class="row align-items-center mb-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="color" class="form-control form-control-color w-100"
                                                   ...
                                                   value="{{ old($campoBase, '#0061f2') }}" style="height: 45px;">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="color" class="form-control form-control-color w-100"
                                                   name="{{ $focus }}" id="{{ $focus }}"
                                                   value="{{ old($focus, '#0056b3') }}" style="height: 45px;">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="color" class="form-control form-control-color w-100"
                                                   ...
                                                   value="{{ old($border, '#007bff') }}" style="height: 45px;">
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="color" class="form-control form-control-color w-100"
                                                   ...
                                                   value="{{ old($gradient, '#3399ff') }}" style="height: 45px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
