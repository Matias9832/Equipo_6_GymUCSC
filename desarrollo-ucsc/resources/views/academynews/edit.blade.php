        ...
        <div class="card">
            <div class="card-body">
                            ...
                            @foreach($news->images as $image)
                                <div class="col-md-3 position-relative">
                                    <div style="width: 100%; height: 200px; overflow: hidden; border-radius: 0.5rem; position: relative;">
                                        ...
                                        <form action="{{ route('academynews.image.destroy', $image->id_imagen) }}" method="POST"
                ...
                @endif
                    ...
                    <form action="{{ route('academynews.update', $news->id_noticia) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
