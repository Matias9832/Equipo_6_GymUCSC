                        ...
                        <form id="formularioSalud" method="POST" action="{{ route('salud.update') }}">
                            ...
                            <div id="formulario_salud" style="display: none;">
                                ...
                                <div class="mb-3 ms-4" id="detalles_enfermo_cronico" style="display: none;">
                                    ...
                                    @php
                                        ...
                                        $cronicasSeleccionadas = $salud->cronicas ?? [];
                                    @endphp
                                    @foreach($opciones as $opcion)
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" name="cronicas[]" value="{{ $opcion }}"
                                                {{ in_array($opcion, $cronicasSeleccionadas) ? 'checked' : '' }}>
                                ...
                                <div class="mb-3 ms-4" id="detalle_alergias" style="display: none;">
                                    ...
                                    <input type="text" name="detalle_alergias" id="detalle_alergias_input" placeholder="Ej: Estacional, alimentaria, medicamentos, etc." class="form-control" value="{{ $salud->detalle_alergias }}">
                                ...
                                <div class="mb-3 ms-4" id="detalle_indicaciones" style="display: none;">
                                    ...
                                    <input type="text" name="detalle_indicaciones" id="detalle_indicaciones_input" placeholder="Ej: No realizar pesas por 3 meses o lesión en el tobillo" class="form-control" value="{{ $salud->detalle_indicaciones }}">
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-3">
                                ...
                                @if(auth()->user()->tipo_usuario === 'admin')
                                    <a href="{{ route('docentes.perfil') }}" class="btn btn-outline-secondary">Volver</a>
                                @else
                                    <a href="{{ route('edit-perfil.edit') }}" class="btn btn-outline-secondary">Volver</a>
                                @endif   
                            </div>
                        </form>
                    </div>
