...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Crear Academia'])
        ...
        <div class="card-body">
            <form action="{{ route('academias.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="nombre_academia" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label for="descripcion_academia" class="form-label">Descripción</label>
                    <textarea name="descripcion_academia" class="form-control" rows="3" required></textarea>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="implementos" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="mensualidad" class="form-control" required>
                </div>
