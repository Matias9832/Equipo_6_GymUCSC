                            ...
                            <table class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Rol / Tipo de usuario</th>
                                        ...
                                        <tr>
                                            ...
                                            @role('Super Admin|Director|Coordinador')
                                                <td class="align-middle text-center">
                                                    @can('Editar Usuarios')
                                                        <a href="{{ route('usuarios.edit', $usuario->id_usuario) }}" class="text-secondary font-weight-bold text-xs me-2" data-toggle="tooltip" title="Editar">
